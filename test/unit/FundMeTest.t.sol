...
contract FundMeTest is Test {
    ...
    function testAddFunderToArrayOfFunders() public {
        vm.prank(USER);
        fundMe.fund{value: SEND_VALUE}();
        assertEq(USER, fundMe.getFunder(0)); // test run separately so user at address 0
    }
    ...
    function testWithdrawWithMutipleFunders() public {
    ...
    function testWithdrawWithMutipleFundersCheaper() public {
        uint160 numberOfFunders = 10;
        uint160 startingFunderIndex = 1;
